...
[source,dos]
----
gfortran src/modules/Kenngroessen.f90 src/transformation.f90 src/helper.f90 src/matrixfuell.f90 src/main.f90 src/einlese.f90 src/FFREAD.FOR src/rconv.FOR -Jbuild -o build/out.exe
----
